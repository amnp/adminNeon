    ...
    <div class="row">
            ...
            <ul class="user-info pull-left pull-none-xsm">
                ...
                <li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <?php echo $this->session->userdata('admin_firstname'); ?>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- Profile sub-links -->
                        <li><?php foreach($ADMINS as $admin){?>

                            <a href="<?php echo base_url();?>index.php/adminneon_c/update_admin/<?php echo $admin->admin_id; ?>">
        ...
        <div class="col-md-6 col-sm-4 clearfix hidden-xs">
            ...
            <ul class="list-inline links-list pull-right">
                ...
                <li>
                    <a href="<?php echo base_url(); ?>index.php/adminneon_c/logout_user">
