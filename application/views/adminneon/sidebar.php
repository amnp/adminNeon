                ...
                <div class="sidebar-menu-inner">
                    ...
                    <ul id="main-menu" class="main-menu">
                        ...
                        <li class="active opened active has-sub">
                            ...
                            <ul class="visible">
                                <li class="active">
                                    <a href="<?php echo site_url();?>/adminneon_c">
                                        <span class="title">Dashboard 1</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/adminneon_c/admin_getdata">
                                        <span class="title">Dashboard 2</span>
                                    </a>
                                </li>
                              <li>
                                    <a href="<?php echo base_url();?>index.php/adminneon_c/get_emp">
